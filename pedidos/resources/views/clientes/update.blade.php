...
@section('conteudo')
        ...
        <form class="form-horizontal" action="{{ route('editar_dados_cliente', ['id' => $cliente->id]) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="endereco" value="{{$cliente->endereco}}"></br><br/>
            </div>
